...
public class CampaingSetup : MonoBehaviour {
    ...
    public IEnumerator ChangeScenes(int chapter) {
        ...
        SceneManager.UnloadSceneAsync(SceneManager.GetActiveScene());
        CampaingController campaingController = Instantiate(Resources.Load<GameObject>("Campaign/Chapter" + chapter), GameObject.Find("Game").transform).GetComponent<CampaingController>();
