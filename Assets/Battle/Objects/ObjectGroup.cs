...
public class ObjectGroup<T> : IObject, IObjectGroupLink where T : BattleObject {
    ...
    public ObjectGroup(BattleManager battleManager, HashSet<T> objects, bool deleteGroupWhenEmpty,
    ...
    public HashSet<T> battleObjects { get; }
    ...
    private float CalculateObjectGroupSize() {
        ...
        return battleObjects.Max(battleObject =>
            Vector2.Distance(position, battleObject.GetPosition()) + battleObject.GetSize());
    }
