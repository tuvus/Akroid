...
public class AsteroidField : ObjectGroup<Asteroid>, IPositionConfirmer {
    ...
    /// <summary>
    ///     SetupAsteroidFieldPosition needs to be called after all asteroids have been added and placed to determine it's
    ///     size.
    ...
    public void SetupAsteroidFieldPosition(BattleManager.PositionGiver positionGiver) {
        ...
        foreach (Asteroid asteroid in battleObjects) {
